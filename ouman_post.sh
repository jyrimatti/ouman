...
#! nix-shell --pure --keep LD_LIBRARY_PATH --keep OUMAN_USER --keep OUMAN_PASSWORD -i dash -I channel:nixos-23.11-small -p dash websocat cacert curl jq nix gnugrep gnused
set -eu
